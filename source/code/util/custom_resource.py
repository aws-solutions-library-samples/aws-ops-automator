...
class CustomResource:
    ...
    def handle_request(self):
        ...
        if self._context is not None:
            timeleft = (self._context.get_remaining_time_in_millis() / 1000.00) - 0.5 if self._context is not None else 300
    ...
    def _send_response(self):
        ...
        try:
            ...
            raise Exception(ERR_SEND_RESP.format(self.stack_id, str(exc), self.response_url, resp))
